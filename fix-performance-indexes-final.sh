...
echo "🔧 ФИНАЛЬНОЕ ИСПРАВЛЕНИЕ ДУБЛИРУЮЩИХСЯ ИНДЕКСОВ В 011-add-performance-indexes.xml"
echo "================================================================================"

cd /home/alex/vuege/src/app

# Создаем резервную копию
cp backend/src/main/resources/db/changelog/changes/011-add-performance-indexes.xml backend/src/main/resources/db/changelog/changes/011-add-performance-indexes.xml.backup2
