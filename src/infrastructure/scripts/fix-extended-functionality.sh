...
echo "🔧 ИСПРАВЛЕНИЕ ДУБЛИРУЮЩИХСЯ КОЛОНОК В 012-add-extended-functionality.xml"
echo "======================================================================"

cd /home/alex/vuege/src/app

# Создаем резервную копию
cp backend/src/main/resources/db/changelog/changes/012-add-extended-functionality.xml backend/src/main/resources/db/changelog/changes/012-add-extended-functionality.xml.backup

# Создаем исправленный файл без дублирующихся колонок
...
echo "✅ Файл исправлен - удалены дублирующиеся колонки created_at и updated_at"
echo ""
