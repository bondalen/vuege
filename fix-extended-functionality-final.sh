...
echo "🔧 ФИНАЛЬНОЕ ИСПРАВЛЕНИЕ 012-add-extended-functionality.xml"
echo "=========================================================="

cd /home/alex/vuege/src/app

# Создаем резервную копию
cp backend/src/main/resources/db/changelog/changes/012-add-extended-functionality.xml backend/src/main/resources/db/changelog/changes/012-add-extended-functionality.xml.backup2

# Создаем исправленный файл с правильным порядком операций
...
<databaseChangeLog
    ...
    <changeSet id="012-001-add-status-to-organizations" author="vuege">
        ...
        <addNotNullConstraint tableName="organizational_units" columnName="created_by"/>
        <addNotNullConstraint tableName="organizational_units" columnName="updated_by"/>
    </changeSet>
    ...
    <changeSet id="008-002-add-extended-fields-to-persons" author="vuege">
        ...
        <addNotNullConstraint tableName="persons" columnName="created_by"/>
        <addNotNullConstraint tableName="persons" columnName="updated_by"/>
    </changeSet>
    ...
    <changeSet id="008-003-add-extended-fields-to-positions" author="vuege">
        ...
        <addNotNullConstraint tableName="positions" columnName="created_by"/>
        <addNotNullConstraint tableName="positions" columnName="updated_by"/>
    </changeSet>
...
echo "✅ Файл исправлен - добавлены значения по умолчанию для created_by/updated_by"
echo ""
