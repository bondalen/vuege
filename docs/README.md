...
1. Определите, относится ли документ к основной или вспомогательной документации
2. Разместите в соответствующей папке (`main/` или `others/`)
3. Обновите README файлы с описанием нового документа
4. Добавьте ссылки в этот общий README
