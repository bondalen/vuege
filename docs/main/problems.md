...
### Описание
При попытке установить отступы 5px слева и справа для фреймов (карточек) на странице организаций отступы не изменялись, несмотря на применение различных CSS техник. Проблема затрагивает:
- Фрейм с поиском и фильтрами
- Фрейм с таблицей организаций  
- Фрейм с вкладками (когда открыт)

### Полезные ссылки
- [Quasar CSS Framework](https://quasar.dev/style/theme-builder)
- [CSS Specificity](https://developer.mozilla.org/en-US/docs/Web/CSS/Specificity)
- [CSS !important](https://developer.mozilla.org/en-US/docs/Web/CSS/important)
- [Quasar Layout System](https://quasar.dev/layout-builder)
...
**Действия**: 
1. Изменение класса страницы с `q-pa-xs` на `q-pa-none` с inline стилем
2. Удаление inline стилей из карточек
3. Упрощение CSS правил

**Результат**: Проблема не решена
**Причина неудачи**: Проблема системного уровня в Quasar Framework
