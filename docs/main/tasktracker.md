...
## Задача: 2025-01-27-01 - Рефакторинг структуры папок проекта
...
## Задача: 2025-08-16-02 - Создание системы учета долговременных проблем
...
- **Шаги выполнения**:
  - [x] Создание файла `docs/main/issues.md` для учета долговременных проблем
...
- **Технические решения**:
  - Централизованный учет проблем в issues.md
...
## Задача: 2025-08-16-01 - Дополнение правил по ведению основных документов проекта
...
## Задача: 2025-08-16-02 - Восстановление после критической ошибки удаления домашней папки

- **Статус**: Завершена
- **Описание**: Восстановление рабочей среды после критической ошибки удаления домашней папки пользователя
- **Критичность**: КРИТИЧЕСКАЯ
- **Шаги выполнения**:
  - [x] Анализ потерь и критичности ситуации
  - [x] Попытка восстановления данных через extundelete (неудачно)
  - [x] Восстановление проекта vuege из git репозитория
  - [x] Создание новых SSH ключей и конфигурации
  - [x] Восстановление базовых настроек npm и bash
  - [x] Добавление защитных мер в .bashrc
  - [x] Восстановление MCP серверов
  - [x] Переустановка Maven зависимостей
  - [x] Переустановка глобальных npm пакетов (Quasar CLI)
  - [x] Настройка Cursor IDE для MCP
  - [x] Проверка всех инструментов разработки
- **Зависимости**: Восстановленная базовая среда
- **MCP Серверы**: Требуют переустановки
- **Количество инструментов**: 27 (требуют восстановления)
- **Тип задачи**: critical-recovery
- **Технические решения**:
  - Восстановление из git репозитория
  - Создание новых SSH ключей
  - Добавление защитных мер в bash
  - Поэтапное восстановление инструментов
- **Результаты**:
  ...
  - ✅ Maven установлен и работает
  - ✅ Quasar CLI установлен глобально
  - ✅ Все инструменты разработки восстановлены
  - ✅ Конфигурация Cursor IDE настроена

---

## Задача: Восстановление MCP серверов после критической ошибки

- **Статус**: Завершена ✅
- **Описание**: Восстановление MCP серверов для Cursor IDE после удаления домашней папки
- **Критичность**: ВЫСОКАЯ
- **Шаги выполнения**:
  - [x] Диагностика текущего состояния MCP серверов
  - [x] Установка git-mcp (версия 2025.7.1)
  - [x] Установка docker-mcp (версия 0.2.1)
  - [x] Попытка установки filesystem-mcp (не найден в PyPI)
  - [x] Создание конфигурационных файлов для всех серверов
  - [x] Создание общей конфигурации в ~/.config/cursor/mcp.json
  - [x] Тестирование работы всех серверов
  - [x] Обновление документации
- **Зависимости**: Восстановленная базовая среда
- **MCP Серверы**: 3 из 4 восстановлены
- **Тип задачи**: mcp-recovery
- **Технические решения**:
  - Использование виртуального окружения Python
  - Создание общей конфигурации MCP
  - Тестирование каждого сервера
- **Результаты**:
  - ✅ postgres-mcp восстановлен и работает
  - ✅ git-mcp установлен и настроен
  - ✅ docker-mcp установлен и настроен
  - ❌ filesystem-mcp не найден в PyPI
  - ✅ Конфигурация создана в ~/.config/cursor/mcp.json
  - ✅ Все серверы протестированы

---

# Отслеживание задач проекта Vuege

## Задача: [2025-01-27-01] Настройка SSH подключения к GitHub
- **Статус**: ✅ Завершена
- **Описание**: Настройка безопасного SSH подключения к GitHub для автоматизации git операций
- **Шаги выполнения**:
  - [x] Проверка существующих SSH ключей
  - [x] Добавление SSH ключа в GitHub аккаунт
  - [x] Тестирование SSH подключения
  - [x] Переключение remote с HTTPS на SSH
  - [x] Создание автоматического скрипта настройки SSH агента
  - [x] Тестирование git операций через SSH
  - [x] Обновление документации
- **Зависимости**: Нет
- **Связанные проблемы**: Нет
- **Результат**: Полностью рабочее SSH подключение к GitHub с автоматизацией
