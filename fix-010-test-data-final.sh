...
echo "🔧 ФИНАЛЬНОЕ ИСПРАВЛЕНИЕ ТЕСТОВЫХ ДАННЫХ"
echo "========================================"
echo "📁 Текущая директория: $(pwd)"
echo "📝 Создание файла 010-test-data.xml с исправленными ID..."
...
<databaseChangeLog
    ...
    <!-- ChangeSet 3: Организационные единицы (исправленные ID) -->
...
echo "✅ Файл 010-test-data.xml создан с исправленными ID"
echo ""
echo "🔍 Проверка исправлений..."
echo "Строки с ID в organizational_units:"
grep -A 5 -B 5 "location_id" /home/alex/vuege/src/app/backend/src/main/resources/db/changelog/changes/010-test-data.xml
echo ""
echo "🚀 Запуск Liquibase с исправленными ID..."
...
echo ""
echo "✅ Финальное исправление тестовых данных завершено!"