#!/bin/bash
echo "🔧 ИСПРАВЛЕНИЕ СТРУКТУРЫ ТЕСТОВЫХ ДАННЫХ"
echo "=========================================="
...
<databaseChangeLog
    ...
    <changeSet id="010-insert-test-data" author="vuege">
        ...
        <!-- Тестовые организационные единицы (БЕЗ description) -->
...
echo "🔍 Проверка исправленной структуры..."
...
echo ""
echo "🚀 Запуск Liquibase с исправленной структурой..."
echo ""
...
echo ""
echo "✅ Исправление структуры тестовых данных завершено!"