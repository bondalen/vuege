#!/bin/bash
echo "🚨 РАДИКАЛЬНОЕ ИСПРАВЛЕНИЕ LIQUIBASE"
echo "====================================="
...
echo "📝 Создание нового файла 008-geo-points-table.xml..."
...
<databaseChangeLog
    ...
    <changeSet id="008-add-geo-points-constraints" author="vuege">
        <addCheckConstraint tableName="geo_points" 
                           constraintName="chk_latitude_range" 
                           checkCondition="latitude &gt;= -90 AND latitude &lt;= 90"/>
        
        <addCheckConstraint tableName="geo_points" 
                           constraintName="chk_longitude_range" 
                           checkCondition="longitude &gt;= -180 AND longitude &lt;= 180"/>
    </changeSet>
...
echo ""
echo "🚀 Запуск Liquibase с новым файлом..."
echo ""
