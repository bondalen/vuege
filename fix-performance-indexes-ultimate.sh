...
echo "🔧 ФИНАЛЬНОЕ ИСПРАВЛЕНИЕ ВСЕХ ДУБЛИРУЮЩИХСЯ ИНДЕКСОВ"
echo "=================================================="

cd /home/alex/vuege/src/app

# Создаем резервную копию
cp backend/src/main/resources/db/changelog/changes/011-add-performance-indexes.xml backend/src/main/resources/db/changelog/changes/011-add-performance-indexes.xml.backup4
...
<databaseChangeLog
    ...
    <changeSet id="011-add-performance-indexes" author="bondalen">
        ...
        <!-- Индексы для person_positions (удалены дублирующиеся - уже созданы в 006-person-positions-table.xml) -->
...
echo "✅ Файл исправлен - удалены все дублирующиеся индексы"
echo ""
