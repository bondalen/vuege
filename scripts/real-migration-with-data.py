#!/usr/bin/env python3
"""
Реальная миграция данных с SQL Server в PostgreSQL
"""
...
class RealDataMigration:
    ...
    def setup_logging(self):
        ...
        logging.basicConfig(
            ...
            handlers=[
                logging.FileHandler('real-migration-with-data.log'),
    ...
    def create_group_report(self, group_name, tables, successful, failed):
        ...
        filename = f"real-migration-{group_name.lower().replace(' ', '-')}-report.json"
...
def main():
    """Основная функция"""
    print("🚀 Реальная миграция данных с SQL Server в PostgreSQL")
    print("=" * 60)
    
    migrator = RealDataMigration()
