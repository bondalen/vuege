...
# -*- coding: utf-8 -*-
"""
Скрипт для получения информации о колонках с читаемыми описаниями
"""

import psycopg2

def get_readable_columns_info():
    """Получить информацию о колонках с читаемыми описаниями"""
    ...
    try:
        ...
        print("=== ИНФОРМАЦИЯ О КОЛОНКАХ 10 ТАБЛИЦ С ЧИТАЕМЫМИ ОПИСАНИЯМИ ===\n")
        
        for table in tables:
            print(f"📋 Таблица: {table}")
            print("Колонки:")
            
            # Получение информации о колонках с читаемыми описаниями
            query = f"""
            SELECT 
                c.column_name,
                mbt.base_type_name,
        ...
        conn.close()
        print("✅ Данные успешно получены из PostgreSQL с читаемыми описаниями")
        
    except Exception as e:
        print(f"❌ Ошибка при получении данных: {e}")

if __name__ == "__main__":
    get_readable_columns_info()